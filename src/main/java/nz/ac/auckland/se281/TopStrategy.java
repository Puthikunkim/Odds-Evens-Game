...
public class TopStrategy implements Strategy {
  ...
  public int getFingers(int playerEvenCount, int playerOddCount, Choice choice) {
    ...
    if (choice == Choice.EVEN) {
      ...
      // If the player chose odd: If the number of even fingers played by the player is greater than
      // the number of even let the AI play an even number. If the number of odd fingers played by
      // the player is greater than the number of even let the AI play an odd number. If the number
